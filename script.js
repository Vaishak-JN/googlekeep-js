class App {
    ...
    addEventListeners() {
        ...
        this.$formCloseButton.addEventListener('click', event => {
            ...
            // prevents bubbling of events here
            this.closeForm()
        })
    ...
    handleFormClick(event) {
        ...
        // if clicked outside form instead of submit btn while text/title is populated
        const title = this.$noteTitle.value
        const text = this.$noteText.value
        const hasNote = title || text
    ...
    displayNotes() {
        ...
        `).join("")
        // use .join() to avoid commas coming up
